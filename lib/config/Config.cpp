...
Config::Config() {
	...
	realParas.insert(make_pair("lambda", 0.7));
	realParas.insert(make_pair("kappa", 1));
	realParas.insert(make_pair("alpha", -1));
	realParas.insert(make_pair("beta", -1));
	realParas.insert(make_pair("max_beta", 0.6));
	//realParas.insert(make_pair("doublet_rate", 0.1));
	
	intParas.insert(make_pair("maxl", 0));
	//intParas.insert(make_pair("beamsize", 5));
	intParas.insert(make_pair("n_init", 100));
	intParas.insert(make_pair("n_iter", 30));
	
	intParas.insert(make_pair("max_iter", 100));
